...
**ChatGPT 中文版入口：[https://chat.lanjingai.org](https://gpt.lanjing.pro)**   
...
3. [国内可用的 ChatGPT 中文版](#国内可用的-chatgpt-中文版)
4. [ChatGPT 官网与中文版的区别](#chatgpt-官网与中文版的区别)
5. [ChatGPT 中文版的使用指南](#chatgpt-中文版的使用指南)
6. [ChatGPT 常见问题解答](#chatgpt-常见问题解答)

---

## 什么是 ChatGPT 中文版？

[**ChatGPT 中文版**](https://gpt.lanjing.pro) 是 OpenAI 开发的 ChatGPT 模型的中文版本，专为中文用户提供更流畅、更精准的 AI 对话体验。   
